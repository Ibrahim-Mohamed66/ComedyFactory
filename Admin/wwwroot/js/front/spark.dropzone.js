...
var previewTemplate = "<div class=\"dz-preview dz-file-preview\">\n " +
    ...
    " <div class=\"dz-filename d-none\"><span data-dz-name></span></div>\n <img src=\"/assets/images/admin/removebutton.png\" class=\"dz-deletor\" data-toggle=\"tooltip\" title=\"Click me to remove the file.\" data-dz-remove /> \n  </div>\n  " +
...
var imgSize = "?w=600&h=600&scale=both&bgcolor=white&format=jpg";
...
$(function () {
    $('div.dropzone.image').each(
        function (i, obj) {
            ...
            if (f.val()) {
                var mockFile = {
                    name: f.val().split('/').pop(), // filename only for alt
                    size: null,
                    url: f.val(),
                    type: 'image/jpeg'
                };
